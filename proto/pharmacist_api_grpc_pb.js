...
function deserialize_pb_AuthenticateUserRequest(buffer_arg) {
  return proto_pharmacist_api_pb.AuthenticateUserRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_pb_AuthenticateUserResponse(arg) {
  if (!(arg instanceof proto_pharmacist_api_pb.AuthenticateUserResponse)) {
    throw new Error('Expected argument of type pb.AuthenticateUserResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_pb_AuthenticateUserResponse(buffer_arg) {
  return proto_pharmacist_api_pb.AuthenticateUserResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function deserialize_pb_CreateUserRequest(buffer_arg) {
  return proto_pharmacist_api_pb.CreateUserRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function deserialize_pb_CreateUserResponse(buffer_arg) {
  return proto_pharmacist_api_pb.CreateUserResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_pb_GenerateAccessTokenFromRefreshTokenRequest(arg) {
  if (!(arg instanceof proto_pharmacist_api_pb.GenerateAccessTokenFromRefreshTokenRequest)) {
    throw new Error('Expected argument of type pb.GenerateAccessTokenFromRefreshTokenRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_pb_GenerateAccessTokenFromRefreshTokenRequest(buffer_arg) {
  return proto_pharmacist_api_pb.GenerateAccessTokenFromRefreshTokenRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_pb_GenerateAccessTokenFromRefreshTokenResponse(arg) {
  if (!(arg instanceof proto_pharmacist_api_pb.GenerateAccessTokenFromRefreshTokenResponse)) {
    throw new Error('Expected argument of type pb.GenerateAccessTokenFromRefreshTokenResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_pb_GenerateAccessTokenFromRefreshTokenResponse(buffer_arg) {
  return proto_pharmacist_api_pb.GenerateAccessTokenFromRefreshTokenResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function deserialize_pb_GetUserByIdRequest(buffer_arg) {
  return proto_pharmacist_api_pb.GetUserByIdRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function deserialize_pb_GetUserByIdResponse(buffer_arg) {
  return proto_pharmacist_api_pb.GetUserByIdResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var AuthService = exports.AuthService = {
  ...
  generateAccessTokenFromRefreshToken: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: proto_pharmacist_api_pb.GenerateAccessTokenFromRefreshTokenRequest,
    responseType: proto_pharmacist_api_pb.GenerateAccessTokenFromRefreshTokenResponse,
    requestSerialize: serialize_pb_GenerateAccessTokenFromRefreshTokenRequest,
    requestDeserialize: deserialize_pb_GenerateAccessTokenFromRefreshTokenRequest,
    responseSerialize: serialize_pb_GenerateAccessTokenFromRefreshTokenResponse,
    responseDeserialize: deserialize_pb_GenerateAccessTokenFromRefreshTokenResponse,
  },
};
