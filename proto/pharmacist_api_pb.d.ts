...
export class GenerateAccessTokenFromRefreshTokenRequest extends jspb.Message { 
    ...
    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): GenerateAccessTokenFromRefreshTokenRequest.AsObject;
    static toObject(includeInstance: boolean, msg: GenerateAccessTokenFromRefreshTokenRequest): GenerateAccessTokenFromRefreshTokenRequest.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: GenerateAccessTokenFromRefreshTokenRequest, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): GenerateAccessTokenFromRefreshTokenRequest;
    static deserializeBinaryFromReader(message: GenerateAccessTokenFromRefreshTokenRequest, reader: jspb.BinaryReader): GenerateAccessTokenFromRefreshTokenRequest;
}
...
export class GenerateAccessTokenFromRefreshTokenResponse extends jspb.Message { 
    ...
    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): GenerateAccessTokenFromRefreshTokenResponse.AsObject;
    static toObject(includeInstance: boolean, msg: GenerateAccessTokenFromRefreshTokenResponse): GenerateAccessTokenFromRefreshTokenResponse.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: GenerateAccessTokenFromRefreshTokenResponse, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): GenerateAccessTokenFromRefreshTokenResponse;
    static deserializeBinaryFromReader(message: GenerateAccessTokenFromRefreshTokenResponse, reader: jspb.BinaryReader): GenerateAccessTokenFromRefreshTokenResponse;
}
