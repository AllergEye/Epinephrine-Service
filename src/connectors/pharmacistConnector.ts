...
import { GetUserByIdRequest, GetUserByIdResponse } from '../../proto/pharmacist_api_pb';

const client = new AuthClient(PHARMACIST_SERVICE_URL, credentials.createSsl())

export const getUserById = async (context: Context, userId: string): Promise<GetUserByIdResponse> => {
